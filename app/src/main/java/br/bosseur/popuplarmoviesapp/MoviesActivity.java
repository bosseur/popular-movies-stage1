...
public class MoviesActivity extends AppCompatActivity implements
  ...
  private static final String STATE_KEY = "sort_order";
  ...
  protected void onRestoreInstanceState(Bundle savedInstanceState) {
    ...
    mSavedState = savedInstanceState.getParcelable(STATE_KEY);
  ...
  protected void onSaveInstanceState(Bundle outState) {
    ...
    outState.putParcelable(STATE_KEY, recyclerView.getLayoutManager().onSaveInstanceState());
  }
